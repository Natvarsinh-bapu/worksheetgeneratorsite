...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            {{ Form::open(array('url' => 'institute/teachers', 'method' => 'POST')) }}
            @csrf
            <div class="row">                    
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    {{ Form::text('phone', null,array('class' => 'form-control', 'id' => 'phone', 'required' => true, 'placeholder' => 'Phone')) }}
                    @if ($errors->has('phone'))
            ...
            <div class="row">                
                @forelse ($classes as $key => $value)
                    <div class="col-md-2">
                        <div>
                            <input type="checkbox" name="classes[]" value="{{ $key }}" id="class_{{ $loop->iteration }}">
