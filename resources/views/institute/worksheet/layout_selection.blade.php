...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body"> 
            ...
            <div class="row" style="display:none;">
                {{ Form::open(array('url' => 'institute/worksheet/create', 'method' => 'GET', 'files' => true)) }}
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2" style="text-align:left;">
                        <a href="/institute/worksheet/create" class="btn btn-info">Clear Filter</a>
                    </div>
                {{ Form::close() }}
            </div>
            <hr>
            ...
            <div class="row">
                @for ($i = 1; $i < 9; $i++)
                    <div class="col-md-3">
                        <a href="{{ url('/institute/layouts/'.$i) }}">
