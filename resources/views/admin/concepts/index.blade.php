    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            <div class="form-group text-left">
                <a href="{{ url('admin/concepts/create') }}" class="btn btn-success">ADD</a>
            </div>

            <div class="row">
                {{-- BASIC TABLE --}}
                <table class="table" id="admin_concepts_table">
                    <thead>
                        <tr>
                            <th>Concept</th>
                            <th>Category</th>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer model-footer-padding">
            {{ Form::open(array('url' => 'admin/delete-concept', 'method' => 'POST')) }}
            @csrf
