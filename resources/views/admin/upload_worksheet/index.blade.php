...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            ...
            {{ Form::open(array('url' => 'admin/worksheet-upload', 'method' => 'POST', 'files' => true, 'id' => 'upload_worksheet_form')) }}
                @csrf
                <div class="row">
                    <div class="col-md-12">
                ...
                @forelse ($worksheets as $item)
                    <div class="col-md-6">
                        ...
                        <div style="padding: 2px 0 10px 0;">
                            {{ Form::open(array('url' => url('admin/upload-worksheets/'.$item->id), 'method' => 'POST')) }}
                                @csrf
                                @method('DELETE')
                                <div style="text-align: center">
                                    <button class="btn btn-danger" type="submit" style=""><i class="fa fa-trash"></i>&nbsp; Delete</button>
                                    <a class="btn btn-success" href="{{ url('admin/worksheet-download/'. $item->id) }}"><i class="fa fa-download"></i>&nbsp; Download</a>
                                </div>
                            {{ Form::close() }}                            
                        </div>
                    </div>
