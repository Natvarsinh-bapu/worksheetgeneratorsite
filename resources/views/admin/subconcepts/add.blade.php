...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            {{ Form::open(array('url' => 'admin/sub-concepts', 'method' => 'POST')) }}
            @csrf
            
            <div class="form-group">
                <label for="category_id">Category</label>
                {{ Form::select('category_id', $categories, '', array('class' => 'form-control', 'id' => 'admin_category_for_sub_concept', 'required' => true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::select('concept_id', [], '', array('class' => 'form-control', 'id' => 'admin_concept_for_sub_concept', 'required' => true)) }}
