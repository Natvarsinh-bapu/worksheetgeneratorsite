            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="display: flex;justify-content:space-between;">
                        <div id="first_{{ $i }}" current-click="first_{{ $i }}" class="worksheet-image-div-main _image_box">
                            <img src="{{ asset('images/clickhere.png') }}" alt="" height="100%" width="100%">
                        </div>                        
                        <div id="second_{{ $i }}" current-click="second_{{ $i }}" class="worksheet-image-div-main _image_box">
                            <img src="{{ asset('images/clickhere.png') }}" alt="" height="100%" width="100%">
                        </div>                        
                    </div>
                </div>
