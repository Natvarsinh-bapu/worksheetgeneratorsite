...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            ...
            <div class="text-center" style="margin-bottom:50px;">
                ...
                <div style="margin-top:10px;">
                    <div class="upload-btn-wrapper">
                        ...
                        {{ Form::open(array('url' => 'admin/change-profile-pic', 'method' => 'POST', 'files' => true, 'id' => 'profile_pic_form')) }}
                            @csrf
            ...
            {{ Form::open(array('url' => 'admin/update-admin-details', 'method' => 'POST', 'id' => 'profile_form')) }}
                <div class="row" style="margin-top:10px;">                
                    <div class="col-md-6">
                        Name: 
                        <span class="_profile_label">{{ $admin->name }} </span>
                        <div>
                            <input id="profile_name" type="text" class="_profile_field" name="name" value="{{ $admin->name }}" style="display:none;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        Phone:
                        <span class="_profile_label"> {{ $admin->details->phone }} </span>
                        <div>
                            <input id="profile_phone" type="text" class="_profile_field" name="phone" value="{{ $admin->details->phone }}" style="display:none;" >
                        </div>
                    </div>                
                </div>
                <div class="row" style="margin-top:10px;">
                ...
                <div class="form-group text-right">
                    ...
                    <a href="{{ url('/admin') }}" class="btn btn-danger _back_btn">Back</a>
