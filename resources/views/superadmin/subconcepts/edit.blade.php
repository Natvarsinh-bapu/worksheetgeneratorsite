...
@section('content')
    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            {{ Form::open(array('url' => array('superadmin/sub-concepts', $sub_concept->id), 'method' => 'PUT')) }}
            @csrf

            <div class="form-group">
                <label for="category_id">Category</label>
                {{ Form::select('category_id', $categories, $sub_concept->category_id, array('class' => 'form-control', 'id' => 'superadmin_category_edit', 'required' => true)) }}
            ...
            <div class="form-group">
                ...
                {{ Form::select('concept_id', [], '', array('class' => 'form-control', 'id' => 'superadmin_concept_edit', 'required' => true)) }}
            ...
            <div class="form-group text-right">
                ...
                <a href="{{ url('superadmin/sub-concepts') }}" class="btn btn-danger">Cancel</a>
            </div>
            {{ Form::close() }}
        </div>
