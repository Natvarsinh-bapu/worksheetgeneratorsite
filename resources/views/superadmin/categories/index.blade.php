    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            <div class="form-group text-left">
                <a href="{{ url('superadmin/categories/create') }}" class="btn btn-success">ADD</a>
            </div>

            <div class="row">
                {{-- BASIC TABLE --}}
                <table class="table" id="superadmin_categories_table">
                    <thead>
                        <tr>
                            <th>Category</th>
                            <th>Action</th>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer model-footer-padding">
            {{ Form::open(array('url' => 'superadmin/delete-category', 'method' => 'POST')) }}
            @csrf
