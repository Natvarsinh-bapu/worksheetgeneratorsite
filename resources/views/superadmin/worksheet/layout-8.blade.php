            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="display: flex;justify-content:space-around;text-align:center;padding:10px;">
                        <div id="first_{{ $i }}" current-click="first_{{ $i }}" class="_image_box" style="height:140px;width:150px;margin:5px;">
                        ...
                        <div id="third_{{ $i }}" current-click="third_{{ $i }}" class="_image_box" style="height:140px;width:150px;margin:5px;">
                            <img src="{{ asset('images/clickhere.png') }}" alt="" height="100%" width="100%">
                        </div>
                        <div style="height:140px;width:150px;margin:5px;">
                            <img src="{{ asset('images/equals.png') }}" alt="" height="100%" width="100%">
                        </div>
                        <div style="height:140px;width:150px;margin:5px;border:1px solid;">
